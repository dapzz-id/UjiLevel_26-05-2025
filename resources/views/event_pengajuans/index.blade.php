...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header Section -->
    <form method="GET" action="{{ route('user.index') }}" class="mb-8">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
            <div class="flex flex-row justify-between items-center">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    <a href="{{ route('user.create') }}" class="mt-4 sm:mt-0 inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 max-md:mr-0 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
                        <p class="max-md:hidden">Ajukan Acara Baru</p>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                <a href="{{ route('user.show', $eventPengajuan->event_id) }}" 

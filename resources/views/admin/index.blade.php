...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header Section -->
    <form method="GET" action="{{ route('admin.index') }}" class="mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="w-full md:w-auto">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Kelola Pengajuan Acara Kegiatan</h1>
                <p class="text-gray-600 mt-1">Kelola semua pengajuan kegiatan dari berbagai ekstrakurikuler</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div class="mb-3 md:mb-0">
                    <h2 class="text-lg font-semibold text-gray-800">Daftar Pengajuan Kegiatan</h2>
                    <p class="text-sm text-gray-500 mt-1">{{ count($eventPengajuans) }} pengajuan (unclosed) ditemukan</p>
                </div>
                <div class="mt-3 md:mt-0 max-md:w-full">
                    <a href="{{ route('admin.index.download') }}" class="inline-flex max-md:w-full items-center justify-center rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
        ...
        <div class="p-8 text-center">
            <div class="max-w-md mx-auto p-6 rounded-xl bg-blue-50 border border-blue-100">
                ...
                <h3 class="mt-3 text-lg font-medium text-blue-800">Tidak ada pengajuan</h3>
                <p class="mt-2 text-sm text-blue-700">
                    Saat ini belum ada pengajuan kegiatan yang tersedia. Silakan periksa kembali nanti.
                </p>
            </div>
        </div>
        @else
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="exportTable">
...
<script>
    ...
    function exportToPDF() {
        ...
        const title = "Daftar Pengajuan Kegiatan (Admin)";
        ...
        doc.setFontSize(10);
        doc.text(`Dicetak pada: ${date}`, 40, 60);
        ...
        doc.autoTable({
            ...
            columnStyles: {
                0: {cellWidth: 100}, // Judul Kegiatan
                1: {cellWidth: 80},  // Pengaju
                2: {cellWidth: 50},  // Jenis
                3: {cellWidth: 70},  // Tanggal Pengajuan
                4: {cellWidth: 70},  // Status Verifikasi
                5: {cellWidth: 70},  // Status Pengajuan
                6: {cellWidth: 40}   // Aksi (empty)
            }
        });
        
        // Save the PDF
        doc.save(`Pengajuan_Kegiatan_Admin_${date.replace(/\//g, '-')}.pdf`);
    }
</script>
@endsection